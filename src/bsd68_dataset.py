"""
BSD68 dataset for image denoising (grayscale, variable size)
Expects images in data/bsd68/ (PNG or JPG)
"""
...
class BSD68Dataset(BaseDenoisingDataset):
    def __init__(
        self,
        root="./data/bsd68",
        noise_type="gaussian",
        ...
        super().__init__(
            name="BSD68",
            description="BSD68 grayscale images for denoising",
            root=root,
